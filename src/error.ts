 ...
 *
 * The draft does not provide specific error handling methods, but it must be treated as a negative
 * scenario.
 */
 ...
 *
 * As this middleware is designed on `Bring-Your-Own-Implementation` pattern, it is possible to use
 * this middleware with unsafe implementation.
 *
